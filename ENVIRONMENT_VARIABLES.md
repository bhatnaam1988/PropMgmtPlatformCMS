...
# Current endpoint: https://alpine-booking-1.preview.emergentagent.com/api/stripe/webhook
...
NEXT_PUBLIC_BASE_URL=https://alpine-booking-1.preview.emergentagent.com
...
- [ ] **Update Base URL**
  ```bash
  NEXT_PUBLIC_BASE_URL=https://[NEW_SESSION].preview.emergentagent.com
  ```
