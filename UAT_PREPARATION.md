...
- **Studio URL:** `https://sanity-nextjs.preview.emergentagent.com/studio`
...
4. Verify webhook endpoint is configured:
   - **URL:** `https://sanity-nextjs.preview.emergentagent.com/api/stripe/webhook`
...
**Sanity Studio:**
- URL: `https://sanity-nextjs.preview.emergentagent.com/studio`
...
**UAT Environment URL:** https://sanity-nextjs.preview.emergentagent.com
