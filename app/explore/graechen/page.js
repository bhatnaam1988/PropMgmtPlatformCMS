  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[400px] md:h-[500px]">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl mb-4">Grächen</h1>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="mb-6">Why We Love Grächen</h2>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          <h2 className="mb-12 text-center">Village Highlights</h2>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="mb-12 text-center">Year-Round Activities</h2>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          <h2 className="mb-12 text-center">Practical Information</h2>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="mb-6">Stunning Mountain Views</h2>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="mb-6 text-center">Authentic Alpine Culture</h2>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 text-center">
          <h2 className="mb-4">Ready to Experience Grächen?</h2>
