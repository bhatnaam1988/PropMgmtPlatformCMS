...
**Your Application URL:** `https://secure-forms-2.preview.emergentagent.com`
**Webhook Endpoint:** `https://secure-forms-2.preview.emergentagent.com/api/stripe/webhook`
...
1. **Make a Test Booking:**
   - Go to: `https://secure-forms-2.preview.emergentagent.com/stay`
...
2. **Create New Webhook for Live Mode:**
   - Same URL: `https://secure-forms-2.preview.emergentagent.com/api/stripe/webhook`
