...
**Your Application URL:** `https://gallery-update-1.preview.emergentagent.com`
**Webhook Endpoint:** `https://gallery-update-1.preview.emergentagent.com/api/stripe/webhook`
...
1. **Make a Test Booking:**
   - Go to: `https://gallery-update-1.preview.emergentagent.com/stay`
...
2. **Create New Webhook for Live Mode:**
   - Same URL: `https://gallery-update-1.preview.emergentagent.com/api/stripe/webhook`
